 ...
 * we donвЂ™t want to send {@link https://developer.mozilla.org/en/xmlhttprequest XHR} or
  ...
  <pre>
    ...
    describe('MyController', function() {
       ...
       it('should send msg to server', function() {
         ...
         // now you donвЂ™t care about the authentication, but
...
function createHttpBackendMock($rootScope, $delegate, $browser) {
   ...
   *    вЂ“ The respond method takes a set of static data to be returned or a function that can return
 ...
 *    an array containing response status (number), response data (string) and response headers
 *    (Object).
 *  - passThrough вЂ“ `{function()}` вЂ“ Any request matching a backend definition with `passThrough`
