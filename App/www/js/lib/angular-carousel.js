...
.directive('rnCarouselAutoSlide', ['$timeout',
    function ($timeout) {
        return {
            restrict: 'A',
...
(function () {
    ...
    .directive('rnCarousel', ['$swipe', '$window', '$document', '$parse', '$compile', '$rootScope',
        function ($swipe, $window, $document, $parse, $compile, $rootScope) {
