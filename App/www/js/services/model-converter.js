 ...
 */
myApp.service("ModelConverter", ["OperationalStatistics", "Visit", "Expenditure", "FieldStat", "LastModified", "UserToken",
    function (OperationalStatistics, Visit, Expenditure, FieldStat, LastModified, UserToken) {
        var classes = {
