...
myApp.directive('loadBar', function () {
    return {
        restrict: 'E',
        replace: true,
        template: '<div class="loading-image"><img style="position:absolute;left:50%; margin-left: -32px;top: 50%;margin-top: -32px;z-index: 1;" src="images/loading2.gif"><div style="height:100%;width:100%;position:fixed;opacity:0.5;background:white;z-index: 90;top: 0%;"></div></div>',
